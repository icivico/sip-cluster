...
public class SessionImpl implements Session {
	...
	public String invite(String requri, Address balancer) {
		if (state instanceof Initial) {
			return ((Initial)state).invite(requri, data.getDestinationURI(), data.getOriginURI(), balancer, data.getLocalSDP());
		} else {
			return null;
		}
	}
